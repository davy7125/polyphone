...
public slots:
    ...
    void lecteurFinished2();
    void applyEQ();
    void initEQ();
    void sifflements(int freq1, int freq2, double raideur);
signals:
    void setData(QByteArray * baDataDroite, QByteArray * baDataGauche,
                 quint32 dwSmplRate);
    void setPlayParameter(int startLoop1, int endLoop1, int typeSmpl,
                          int startLoop2, int endLoop2, bool boucle,
                          bool sinus, int tune, int rootKey, int volume,
                          int stereo);
    void start();
    void stop();
private:
