...
public:
    ...
    static QByteArray bpsConversion(QByteArray baData, WORD wBpsInit, WORD wBpsFinal);
    ...
    static QByteArray enleveBlanc(QByteArray baData, double seuil, WORD wBps, qint32 &pos);
