...
void Page_Prst::duplication()
{
    ...
    // Reprise de l'identificateur si modification
    id = this->tree->getID(0);
    // Modification pour chaque instrument lié
    EltID id2 = id;
    id2.typeElement = elementPrstInst;
    int nbPrstInst = this->sf2->count(id2);
...
void Page_Prst::duplication(EltID id)
{
    // Etendue de l'instrument sur le clavier
