...
DialogExportList::DialogExportList(Pile_sf2 *sf2, EltID id, QWidget *parent) :
    QDialog(parent),
    _init(true),
    ui(new Ui::DialogExportList)
{
    ...
    _init = false;
    switch (ConfManager::getInstance()->getToolValue(ConfManager::TOOL_TYPE_SF2, "presetlist", "format", 0).toInt())
    {
    case 0:
...
void DialogExportList::on_radioCsv_clicked()
{
    ...
    ConfManager::getInstance()->setToolValue(ConfManager::TOOL_TYPE_SF2, "presetlist", "format", 0);
...
void DialogExportList::on_radioHtml_clicked()
{
    ...
    ConfManager::getInstance()->setToolValue(ConfManager::TOOL_TYPE_SF2, "presetlist", "format", 1);
