...
class SfArkExtractorV1
{
public:
    SfArkExtractorV1(Pile_sf2 *sf2);
    ~SfArkExtractorV1();
...
private:
    ...
    int extractSfArk(QString inputFile, QString outputFile);
    int openSfarkFile(const void * name);
    ...
    int SfarkOpen(const void *sfarkName);
    void *SfarkGetBuffer();
