...
void InputSfz::processInternal(QString fileName, SoundfontManager * sm, bool &success, QString &error, int &sf2Index, QString &tempFilePath)
{
    ...
    if (inputFile.open(QIODevice::ReadOnly))
    {
        ...
        else
        {
            ...
            sm->set(idSf2, champ_name, QObject::trUtf8("Import sfz"));
        }
        sm->set(idSf2, champ_ICMT, QObject::trUtf8("Sf2 importé depuis un fichier sfz par Polyphone"));
...
QString InputSfz::getNomInstrument(QString filePath, int &numBank, int &numPreset)
{
