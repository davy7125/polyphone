...
void ConversionSfz::convert(QString dir, QList<EltID> listID, bool presetPrefix, bool bankDir, bool gmSort)
{
    ...
    QString rootDir = QFileInfo(_sf2->getQstr(idSF2, champ_filenameInitial)).baseName();
    if (rootDir.isEmpty())
...
ParamListe::ParamListe(SoundfontManager * sf2, EltID id)
{
...
ParamListe::ParamListe(SoundfontManager * sf2, ParamListe * paramPrst, EltID idInst)
{
...
void ParamListe::adaptLfo(SoundfontManager * sf2, EltID idInstSmpl)
{
...
void ParamListe::load(SoundfontManager * sf2, EltID id)
{
