    ...
    _toolExport(new ToolSoundfontExport())
{
    ...
    _saveAsAction = new QAction(trUtf8("Sauvegarder sous..."), this);
    ...
    _fullScreenAction = new QAction(trUtf8("Plein écran"), this);
    ...
    _helpAction = new QAction(trUtf8("À propos de Polyphone..."), this);
