    ...
    ui(new Ui::DialogCeleste)
{
    ...
    ui->doubleSpinHerz->setValue(ContextManager::configuration()->getToolValue(
                                     ConfManager::TOOL_TYPE_INSTRUMENT, "ondulation", "herz", 4.).toDouble());
    ui->doubleSpinDiv->setValue(ContextManager::configuration()->getToolValue(
    ...
    ui->label->setText(trUtf8("Nombre de battements par secondes (note ") +
                       ContextManager::keyName()->getKeyName(60) + ")");
}
...
void DialogCeleste::accept()
{
    ...
    ContextManager::configuration()->setToolValue(ConfManager::TOOL_TYPE_INSTRUMENT, "ondulation", "herz", ui->doubleSpinHerz->value());
    ContextManager::configuration()->setToolValue(ConfManager::TOOL_TYPE_INSTRUMENT, "ondulation", "division", ui->doubleSpinDiv->value());
