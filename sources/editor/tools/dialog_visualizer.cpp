    ...
    _initialID(id)
{
    ...
    ui->comboParameter->setCurrentIndex(ContextManager::configuration()->getToolValue(
    ...
    ui->checkLog->setChecked(ContextManager::configuration()->getToolValue(
                                 _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                 "visualizer", "logScale", false).toBool());
    ui->checkLog->blockSignals(false);

    // Draw
    this->on_checkLog_stateChanged(ContextManager::configuration()->getToolValue(
                                       _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                       "visualizer", "logScale", false).toBool());
