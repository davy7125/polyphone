    ...
    _isPrst(isPrst)
{
    ...
    ui->checkForEachKey->setChecked(ContextManager::configuration()->getToolValue(
                                        _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                        "duplication", "duplicationKeys", true).toBool());
    ui->checkForEachVelocityRange->setChecked(ContextManager::configuration()->getToolValue(
                                                  _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
