    ...
    _isPrst(isPrst)
{
    ...
    ui->comboValeur->setCurrentIndex(ContextManager::configuration()->getToolValue(
    ...
    ui->comboMotif->setCurrentIndex(ContextManager::configuration()->getToolValue(
                                        _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                        "global", "motif", 0).toInt());
    ui->comboMotif->blockSignals(false);
    ui->doubleSpinRaideur->blockSignals(true);
    ui->doubleSpinRaideur->setValue(ContextManager::configuration()->getToolValue(
                                        _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                        "global", "raideur", 50.).toDouble());
    ui->doubleSpinRaideur->blockSignals(false);
    ui->doubleSpinMin->blockSignals(true);
    ui->doubleSpinMin->setValue(ContextManager::configuration()->getToolValue(
                                    _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                    "global", "mini", 0.).toDouble());
    ui->doubleSpinMin->blockSignals(false);
    ui->doubleSpinMax->blockSignals(true);
    ui->doubleSpinMax->setValue(ContextManager::configuration()->getToolValue(
                                    _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                    "global", "maxi", 0.).toDouble());
    ui->doubleSpinMax->blockSignals(false);
    ui->comboModif->blockSignals(true);
    ui->comboModif->setCurrentIndex(ContextManager::configuration()->getToolValue(
                                        _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                        "global", "modification", 0).toInt());
    ui->comboModif->blockSignals(false);
    ui->graphParamGlobal->setMinMax(ContextManager::configuration()->getToolValue(
                                        _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                        "global", "mini", 0.).toDouble(),
                                    ContextManager::configuration()->getToolValue(
                                        _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                        "global", "maxi", 1.).toDouble());
    ui->spinVelMin->setValue(qMin(ContextManager::configuration()->getToolValue(
                                      _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                      "global", "miniVel", 0).toInt(),
                                  ContextManager::configuration()->getToolValue(
                                      _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                      "global", "maxiVel", 127).toInt()));
    ui->spinVelMax->setValue(qMax(ContextManager::configuration()->getToolValue(
                                      _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
                                      "global", "miniVel", 0).toInt(),
                                  ContextManager::configuration()->getToolValue(
                                      _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
    ...
    ui->graphParamGlobal->setMinMaxX(ContextManager::configuration()->getToolValue(
                                         _isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
    ...
    // Zone du clavier
    ui->graphParamGlobal->setEtendueClavier(ContextManager::configuration()->getValue(ConfManager::SECTION_KEYBOARD, "type", 0).toInt());
}
...
void DialogParamGlobal::accept()
{
    ...
    ContextManager::configuration()->setToolValue(_isPrst ? ConfManager::TOOL_TYPE_PRESET : ConfManager::TOOL_TYPE_INSTRUMENT,
