Когда инструмент или один из его разделов выбран в [дереве][tree], [меню инструментов][tools] содержит несколько средств, отсортированных по четырём категориям:
