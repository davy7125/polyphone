...
: Приглушение в децибелах, применённое к семплу.\
  Примечание: Формат sf2 не допускает отрицательного значения этого параметра, поэтому усиление невозможно.
...
: ![без петли](images/loop_off.png "без петли"){.inline} указывает, что звук воспроизводится без петли,
  ...
  Примечание: При разработке формата sf2 не планировалось наличие специального режима воспроизведения, который запускает семпл при отпускании клавиши.
